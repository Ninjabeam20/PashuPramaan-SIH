export const getVetDashboard = async () => {
  ...
  return {
    ...
    prescriptions: {
      total: 4,
      items: [
        { rx_id: "Rx-208", farm: "Shanti Dairy", animal_flock: "MP-104", diagnosis: "Clinical mastitis", status_badges: [{ text: "SIGN", variant: "sign" }], aware_badge: { text: "ACCESS", variant: "access" }, time: "10:42", action_text: "Review \u2192" },
        ...
        { rx_id: "Rx-205", farm: "Krishna Dairy", animal_flock: "MP-118", diagnosis: "Clinical mastitis", status_badges: [{ text: "SIGN", variant: "sign" }, { text: "WATCH", variant: "watch" }], aware_badge: { text: "CIA", variant: "cia" }, time: "Yesterday", action_text: "Review \u2192" },
